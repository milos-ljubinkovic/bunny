...
public class CWLInputSecondaryFilesProcessor implements CWLPortProcessorCallback {
  ...
  public CWLPortProcessorResult process(Object value, ApplicationPort port) throws Exception {
    if (((CWLSchemaHelper.isFileFromValue(value) || CWLSchemaHelper.isDirectoryFromValue(value)) ||
      ...
      List<Map<String, Object>> secondaryFiles = CWLProcessor.getSecondaryFiles(job, null, clonedValue,  CWLFileValueHelper.getPath(clonedValue), secondaryFilesObj, workingDir);
