    ...
    case FAILED:
      ...
      if (jobRecord.isRoot()) {
        try {
          ...
          jobService.handleJobRootFailed(Job.cloneWithMessage(rootJob, event.getMessage()));
        ...
        try {
          ...
          jobService.handleJobFailed(Job.cloneWithMessage(failedJob, event.getMessage()));
